...
<h4 class="inner_title"> Creat New Expenses </h4>
...
<div class="ldg_box l_mdeium" >
		  ...
		  <?= $this->Form->input('from_date', array(
            'label'=>'Expense Date', 'id'=> 'birthday', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'style'=>'width:150px'
        )); ?>
</</div>
<div  style="width:100%">
...
<div style="width:350px;float:left">
 <?= $this->Form->input('VCH_AMOUNT', array(
            'label'=>'Amount', 'type'=>'text', 'style'=>'width:150px'
        )); ?>
</div>
<!--<div style="width:350px;float:left">
 <?= $this->Form->input('VCH_CR_ACCOUNTS', array(
            'label'=>'Credit From', 'options'=> $cash_name, 'type'=>'select', 'style'=>'width:150px'
        )); ?>
</</div>
</</div>-->
...
<?= $this->Form->end() ?>
<div style='font-size:20px'><?=$this->Html->link("Cancel", array('controller'=> 'OfficeExpenses', 'action'=> 'index')) ;?> Or</div>
