...
<div class="dash_board">
	<table border="0" style="width:100%"><tr><td style="width:250px;vertical-align:top">
		<div class="dash_left">
			<div class="box">         
				<h1 class="bar_title small_h">OfficeExpenses</h1>
				<ul>
<li class='plus'><?php echo $this->Html->link("Create OfficeExpenses", array('controller' => 'OfficeExpenses', 'action' => 'add')); ?></li>
...
<div style="padding:5px;border:1px solid #CCC;margin:10px">
                ...
                <table style=" padding:10px" cellpadding="5" width="500px">
                    ...
                    <td class="td_class"><?php echo $OfficeExpenses->VCH_FULL_DESCRIPTION?></td>
                    </tr>
                      <tr>
                    <td width="150"><strong>Narration</strong></td>
                    <td class="td_class"><?php echo $OfficeExpenses->VCH_NARRATION?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Date:</strong></td>
                    <td class="td_class"><?php echo date('d-m-Y',strtotime($OfficeExpenses->VCH_DATE))?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Amount:</strong></td>
                    <td class="td_class"><?php echo number_format($OfficeExpenses->VCH_AMOUNT,2)?></td>
                    </tr>
...
<fieldset>
<legend><?= __('Delete OfficeExpenses') ?></legend>
