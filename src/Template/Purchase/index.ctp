<div class="dash_board">
            <table border="0" style="width:100%"><tr><td style="width:250px;vertical-align:top">
                ...
                <div class="dash_content">
        		                                ...
        		                                <h1 class="bar_title small_h">Purchase List :
...
<div style="padding-bottom:30px;">
 ...
 <div style="float:right;width:800px;height:50px !important;padding:2px;">
											 <?= $this->Form->create($Purchase) ?> <span style="float:left;margin-top:10px;font-weight:700" >Search : &nbsp;&nbsp;</span>
                                              <?= $this->Form->input('sdate', array(
            'label'=>'From ', 'id'=> 'employ_date', 'type'=>'text', 'style'=>'margin-right:20px', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'style'=>'width:150px;margin-right:5px;'
        )); ?>
          <?= $this->Form->input('edate', array(
            'label'=>'To', 'id'=> 'birthday', 'type'=>'text', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'style'=>'width:150px'
        )); ?>
         <?php

      echo $this->Form->button('View Purchase Vouchers', array('style'=>'float:right;margin-top:5px;'));

?></div>
</</div>

<?php  $tabledata=$Purchase;
