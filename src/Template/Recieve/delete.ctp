...
<div style="padding:5px;border:1px solid #CCC;margin:10px">
                ...
                <table style=" padding:10px" cellpadding="5" width="500px">
                    ...
                    <td class="td_class"><?php echo $Recieve->VCH_FULL_DESCRIPTION?></td>
                    </tr>
                      <tr>
                    <td width="150"><strong>Narration</strong></td>
                    <td class="td_class"><?php echo $Recieve->VCH_NARRATION?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Date:</strong></td>
                    <td class="td_class"><?php echo date('d-m-Y',strtotime($Recieve->VCH_DATE))?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Amount:</strong></td>
                    <td class="td_class"><?php echo number_format($Recieve->VCH_AMOUNT,2)?></td>
                    </tr>
