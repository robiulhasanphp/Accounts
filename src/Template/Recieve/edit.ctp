...
<?php		echo '<div class="radio_all">';
				...
				echo $this->Form->radio(
					'payment_mode', [['value'=> '0', 'checked'=>'checked', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:blue; margin-top:-2px;width:100px;float:left']
					...
					echo $this->Form->radio(
					'payment_mode', [['value'=> '0', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:blue; margin-top:-2px;width:100px;float:left'], ['value'=> '2', 'checked'=>'checked', 'text'=> 'Check', 'id'=> 'pmode', 'style'=> 'color:blue; margin-top:-2px;width:100px;float:left'], ]
				);
				}
...
?>
 <div id="bank_list" class="proj_dep">
	   <?php echo $this->Form->input('VCH_DR_ACCOUNTS', ['style'=>'width:400px;float:left', 'label'=> 'Recieved To', 'options'=> $paid_to, 'type'=>'select', 'selected'=>'selected'
			]);
		?>
</</div>
<div class="clr"></div>
