...
<h4 class="inner_title">New Payment</h4>
...
<?php		echo '<div class="radio_all">';
				...
				if( $Payment->VCH_CR_ACCOUNTS==3){
				echo $this->Form->radio(
					'payment_mode', [['value'=> '0', 'checked'=>'checked', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:red; float:left;'], ['value'=> '2', 'text'=> 'Check', 'id'=> 'pmode', 'style'=> 'color:blue; float:left;'], ]
				);
				}
				else{
					echo $this->Form->radio(
...
<?php
            ...
            echo $this->Form->input('VCH_FULL_DESCRIPTION', ['rows'=> '3', 'label'=> 'Remarks'
					]
				);
?>
	<div class="clr"></div>
