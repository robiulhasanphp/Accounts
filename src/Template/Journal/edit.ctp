...
<?= $this->Form->create('Createvoucher', ['onSubmit'=>"return CheckAndSubmit()"]);  ?>
			<div class="proj_dep">
					<?=$this->Form->input('VCH_PROJECT', ['options'=> $department, 'type'=>'select', 'class'=>'dd', 'label'=> 'Department', ]);
					?>

					<?=$this->Form->input('VCH_DEPARTMENT', ['class'=>'dd', 'label'=> 'Project', 'options'=> $project, 'type'=>'select'
				...
				<div class="proj_dep">
							...
							<?=$this->Form->input('pdate', ['id'=> 'birthday', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Date', 'placeholder'=>'date', ]);
							?>
</</div>
</</div>
						<div class="proj_dep" >
									<?=$this->Form->input('VCH_NARRATION', ['type'=> 'text', 'class'=>'dd', 'rows'=> 3, 'style'=> 'height:100px;', 'label'=> 'Description', 'placeholder'=>'Description', ]);
									?>
</</div>

<div class="ldg_box l_Vbig">
			<div style="width:220px;float:left">
			 	<?=$this->Form->input('VCH_CR_ACCOUNTS', ['class'=>'dd', 'label'=> 'Cash', 'options'=> $LDG_name, 'type'=>'select'
			...
			<div style="width:220px;float:left">
			 <?=$this->Form->input('VCH_NARRATION_1', ['type'=> 'text', 'class'=>'dd', 'rows'=> 3, 'style'=> 'height:50px;', 'label'=> 'Description', 'placeholder'=>'Description', ]);
									?>
</</div>

<div style="width:150px;float:left">
			 <?= $this->Form->input('debit_amount', array(
						'label'=>'DR', 'id'=> 'VCH_DR_AMOUNT', 'type'=>'text', 'placeholder'=>'DR', 'style'=>'width:120px'
					)); ?>
</</div>

<div style="width:150px;float:left">
			 <?= $this->Form->input('credit_amount', array(
						'label'=>'CR', 'id'=> 'VCH_CR_AMOUNT', 'type'=>'text', 'placeholder'=>'CR', 'style'=>'width:120px'
					)); ?>
</</div>
</</div>
...
<div class="ldg_box l_Vbig">
			<div style="width:220px;float:left">
				<?=$this->Form->input('VCH_DR_ACCOUNTS', ['class'=>'dd', 'label'=> 'Purchase', 'options'=> $LDG_name, 'type'=>'select'
			...
			<div style="width:220px;float:left">
			 <?=$this->Form->input('VCH_NARRATION_2', ['type'=> 'text', 'class'=>'dd', 'rows'=> 3, 'style'=> 'height:50px;', 'label'=> '', 'placeholder'=>'Description', ]);
									?>
</</div>

								<div style="width:150px;float:left">
			 <?= $this->Form->input('debit_amount_2', array(
						'label'=>'', 'id'=> 'DR_AMOUNT', 'type'=>'text', 'placeholder'=>'DR', 'style'=>'width:120px'
					)); ?>
</</div>

<div style="width:150px;float:left">
			 <?= $this->Form->input('credit_amount_2', array(
						'label'=>'', 'id'=> 'CR_AMOUNT', 'type'=>'text', 'placeholder'=>'CR', 'style'=>'width:120px'
					)); ?>
</</div>
</</div>
