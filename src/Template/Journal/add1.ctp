...
<div id="date">
		...
		<?=$this->Form->input('pay_date', ['id'=> 'birthday', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'DMY', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Purchase Date', ]);
        ?>
</</div>
</</div>

		  <div class="proj_dep">           <div style="width:700px;"?>
        <?=$this->Form->input('VCH_DR_ACCOUNTS', ['label'=> 'Item', 'options'=>$item, 'type'=>'select', 'style'=>'width:400px;float:left'
        ...
        <div class="h_border"></div>
		          ...
		          <div class="proj_dep">
                    <?=$this->Form->input('VCH_INV_NO', ['class'=>'dd', 'type'=> 'text', 'label'=> 'Invoice/bill no'

]);
                    ?>

<?=$this->Form->input('check_date', ['id'=> 'employ_date', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Date', ]);
                    ?>
</</div>

<div class="proj_dep">
				                      <?=$this->Form->input('VCH_CHALLAN_NO', ['class'=>'dd', 'type'=> 'text', 'label'=> 'chalan no'

]);
                    ?>

<?=$this->Form->input('CHALLANDATE', ['id'=> 'chalan_date', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Date', ]);
                        ?>
</</div>

<div class="proj_dep" style="background:#DBEAF9;height:auto;border:1px solid #ccc;">         <div style="width:500px;margin:auto;float:none">

		<?=$this->Form->input('VCH_AMOUNT', ['type'=> 'text', 'class'=>'dd', 'label'=> 'Purchase Amount', 'style'=>'width:300px;height:40px;text-align:center;margin-left:20px;font-size:20px !important;padding:6px !important;color:blue !important'
   ...
   <div class="proj_dep">
        		<?=$this->Form->input('VCH_NARRATION', ['type'=> 'textarea', 'label'=> 'Remarks', 'style'=>'width:500px;float:left'
...
<div class="ldg_box l_Vbig">
                                        ...
                                        <?=$this->Form->input('VCH_ACCOUNT_MAIN', ['class'=>'dd', 'label'=> 'A/C Head', 'options'=> $LDG_name, 'type'=>'select', 'style'=>'width:219px'
										...
										<?=$this->Form->input('ACCOUNT_MAIN_NARRATION', ['type'=> 'text', 'label'=> 'Description', 'placeholder'=>'Description', 'style'=>'width:319px'
										]);
										?>
</</div>
...
<div style="width:100px;float:left">
                                                ...
                                                'label'=>'DR', 'id'=> 'VCH_DR_AMOUNT', 'type'=>'text', 'placeholder'=>'DR', 'style'=>'width:98px;text-align:right'
                                                )); ?>
</</div>

<div style="width:100px;float:left">
													<?= $this->Form->input('VCH_CR_AMOUNT_MAIN', array(
													'label'=>'CR', 'id'=> 'VCH_CR_AMOUNT', 'type'=>'text', 'placeholder'=>'CR', 'style'=>'width:98px;text-align:right'
													)); ?>
</</div>
</</div>
...
<?php for($i=0;$i<5;$i++) { ?>
                <div style="width:810px;float:left;padding:2px;height:35px;border:1px solid #ddd;border-bottom:none;border-top:none">
										...
										<div style="width:220px;float:left">
                                        <?=$this->Form->input('VCH_ACCOUNTS['.$i.']', ['label'=> '', 'empty'=> '- Select -', 'options'=> $LDG_name, 'type'=>'select', 'style'=>'width:219px'
										...
										<div style="width:320px;float:left">
										<?=$this->Form->input('VCH_NARRATION['.$i.']', ['label'=>'', 'type'=> 'text', 'placeholder'=>'Description', 'style'=>'width:319px'
										]);
										?>
</</div>
...
<div style="width:100px;float:left">
												...
												'label'=>'', 'id'=> 'VCH_DR_AMOUNT['.$i.']', 'type'=>'text', 'placeholder'=>'DR', 'style'=>'width:98px;text-align:right'
                                                )); ?>
</</div>

<div style="width:100px;float:left">
													<?= $this->Form->input('credit_amount['.$i.']', array(
													'id'=> 'VCH_CR_AMOUNT['.$i.']', 'type'=>'text', 'placeholder'=>'CR', 'label'=>'', 'style'=>'width:98px;text-align:right'
													)); ?>
</</div>
</</div>
...
<br/>
	   	...
	   	<div style="width:540px;float:left;font-size:14px;padding:6px;margin-top:14px;text-align:right">&nbsp;<b>Total</d></div>
												...
												'label'=>'', 'id'=> 't_debit', 'type'=>'text', 'placeholder'=>'Total Debit', 'readonly'=>true, 'style'=>'width:98px;text-align:right;'
                                                )); ?>
</</div>

                                                <div style="width:100px;float:left">
                                                <?= $this->Form->input('t_credit', array(
												'label'=>'', 'id'=> 't_credit', 'type'=>'text', 'placeholder'=>'Total Credit', 'readonly'=>true, 'style'=>'width:98px;text-align:right;'
                                                )); ?>
</</div>
