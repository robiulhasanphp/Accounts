   ...
   <div class="proj_dep">
        ...
        ?>
                            ...
                            <div class="ldg_box l_Vbig">
                                        ...
                                        <?=$this->Form->input('VCH_ACCOUNTS_MAIN', ['class'=>'dd', 'id'=>'VCH_ACCOUNTS_MAIN', 'label'=> 'A/C Head', 'options'=> $LDG_name, 'type'=>'select', 'style'=>'width:219px'
										...
										<?=$this->Form->input('VCH_NARRATION_MAIN', ['type'=> 'text', 'label'=> 'Description', 'placeholder'=>'Description', 'style'=>'width:319px'
										]);
										?>
</</div>
...
<div style="width:100px;float:left">
                                                ...
                                                'label'=>'DR', 'id'=> 'VCH_DR_AMOUNT_MAIN', 'type'=>'text', 'placeholder'=>'DR', 'style'=>'width:98px;text-align:right'
                                                )); ?>
</</div>

<div style="width:100px;float:left">
													<?= $this->Form->input('VCH_CR_AMOUNT_MAIN', array(
													'label'=>'CR', 'id'=> 'VCH_CR_AMOUNT_MAIN', 'type'=>'text', 'placeholder'=>'CR', 'style'=>'width:98px;text-align:right'
													)); ?>
</</div>
</</div>
...
<?php for($i=0;$i<5;$i++) { ?>
                <div style="width:810px;float:left;padding:2px;height:35px;border:1px solid #ddd;border-bottom:none;border-top:none">
										...
										<div style="width:220px;float:left">
                                      <?php if ($i>0){
									    echo $this->Form->input('VCH_ACCOUNTS['.$i.']', ['label'=> '', 'empty'=> '- Select -', 'id'=>'VCH_ACCOUNTS['.$i.']', 'options'=> $LDG_name, 'type'=>'select', 'style'=>'width:219px'

]);
                                        }
										else
										{
										echo $this->Form->input('VCH_ACCOUNTS['.$i.']', ['label'=> '', 'id'=>'VCH_ACCOUNTS['.$i.']', 'options'=> $LDG_name, 'type'=>'select', 'style'=>'width:219px'
										...
										<div style="width:320px;float:left">
										<?=$this->Form->input('VCH_NARRATIONS['.$i.']', ['label'=>'', 'id'=>'VCH_NARRATIONS['.$i.']', 'type'=> 'text', 'placeholder'=>'Description', 'style'=>'width:319px'
										]);
										?>
</</div>
