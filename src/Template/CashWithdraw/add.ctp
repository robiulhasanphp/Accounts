...
<div class="clr"></div>
		 <div class="proj_dep">
			 ...
			 <?php echo $this->Form->input('VCH_CR_ACCOUNTS', ['style'=>'width:400px;float:left', 'label'=> 'Bank Name', 'options'=> $bank_name, 'type'=>'select', 'selected'=>'selected'
...
<?php		echo '<div class="radio_all">';
				...
				echo $this->Form->radio(
					'CashWithdraw_mode', [['value'=> '0', 'checked'=>'checked', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:red; float:left;'], ['value'=> '2', 'text'=> 'Withdraw To', 'id'=> 'pmode', 'style'=> 'color:blue; float:left;'], ]
				);
			echo '</div>';
?>
 <div id="bank_list" class="proj_dep">
	   <?php echo $this->Form->input('VCH_DR_ACCOUNTS', ['style'=>'width:400px;float:left', 'label'=> 'Withdraw To', 'options'=> $bank_name, 'type'=>'select', 'selected'=>'selected'
			]);
		?>
</</div>
...
<?php
            echo $this->Form->input('VCH_AMOUNT', array(
				'label'=> 'Withdraw Amount', 'type'=> 'text'
			));
?>
	<div class="clr"></div>
<?php
