...
$month= array('01'=> 'JAN', '02'=> 'FEB', '03'=> 'MARCH', '04'=> 'APRIL', '05'=> 'MAY', '06'=> 'JUN', '07'=> 'JULY', '08'=> 'AUG', '09'=> 'SEP', '10'=> 'OCT', '11'=> 'NOV', '12'=> 'DEC', );
...
<?=$this->Form->input('from_month', ['id'=> 'birthday', 'type'=>'select', 'class'=>'dd', 'options'=> $month, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> '', 'Placeholder'=> 'MONTH', 'style'=>'border:1px solid #ccc;width:100px;'

]);
						?>

<?=$this->Form->input('from_year', ['id'=> 'employ_date', 'type'=>'select', 'class'=>'dd', 'options'=> $year, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'Placeholder'=> 'YEAR', 'label'=> '', 'style'=>'border:1px solid #ccc;width:100px;'
...
<div class="small_box">
         ...
         <?=$this->Form->input('to_month', ['id'=> 'birthday', 'type'=>'select', 'class'=>'dd', 'options'=> $month, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> '', 'Placeholder'=> 'MONTH', 'style'=>'border:1px solid #ccc;width:100px;'

]);
						?>

<?=$this->Form->input('to_year', ['id'=> 'employ_date', 'type'=>'select', 'class'=>'dd', 'options'=> $year, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'Placeholder'=> 'YEAR', 'label'=> '', 'style'=>'border:1px solid #ccc;width:100px;'
