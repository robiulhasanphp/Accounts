	...
	<table border="0" style="width:100%"><tr><td style="width:250px;vertical-align:top">
		<div class="dash_left">
			<div class="box">         
				...
				<ul>
<li class='plus'><?php echo $this->Html->link("Create Sales", array('controller' => 'Sales', 'action' => 'add')); ?></li>
...
<div style="padding:5px;border:1px solid #CCC;margin:10px">
                ...
                <table style=" padding:10px" cellpadding="5" width="500px">
                    ...
                    <td class="td_class"><?php echo $Sales->VCH_NARRATION?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Date:</strong></td>
                    <td class="td_class"><?php echo date('d-m-Y',strtotime($Sales->VCH_DATE))?></td>
                    </tr>
                    <tr>
                    <td width="150"><strong>Voucher Amount:</strong></td>
                    <td class="td_class"><?php echo number_format($Sales->VCH_AMOUNT,2)?></td>
                    </tr>
