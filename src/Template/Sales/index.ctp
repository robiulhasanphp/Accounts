<div class="dash_board">
            <table border="0" style="width:100%"><tr><td style="width:250px;vertical-align:top">
                ...
                <div class="dash_content">
        		                                ...
        		                                <h1 class="bar_title small_h">Sales List :
...
<div style="padding-bottom:30px;">
 ...
 <div style="float:right;width:800px;height:50px !important;padding:2px;">
											 <?= $this->Form->create($Sales) ?> <span style="float:left;margin-top:10px;font-weight:700" >Search : &nbsp;&nbsp;</span>
      ...
      echo $this->Form->button('View Sales Vouchers', array('style'=>'float:right;margin-top:5px;'));
