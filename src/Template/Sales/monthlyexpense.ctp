...
<h5 style="padding-left:10px;" align="right"><?php echo $this->Html->link("Add new employee", array('controller'=> 'employee', 'action'=> 'add')); ?></h5>
</</div>

   <?php
$monthname= array('1'=> 'JAN', '2'=> 'FEB', '3'=> 'MARCH', '4'=> 'APril', '5'=> 'MAY', '6'=> 'JUN', '7'=> 'JULY', '8'=> 'AUG', '9'=> 'SEP', '10'=> 'OCT', '11'=> 'NOV', '12'=> 'DEC');
...
<?= $this->Form->input('month_name', array(
            'label'=>'Month', 'options'=> $monthname, 'type'=>'select', 'style'=>'border:1px solid #ccc;width:100px;'
        )); ?>

<?= $this->Form->input('year', array(
            'label'=>'year', 'options'=> $year, 'type'=>'select', 'style'=>'border:1px solid #ccc;width:100px;'
        )); ?>
