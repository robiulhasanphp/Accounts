...
<h5 style="padding-left:10px;" align="right"><?php echo $this->Html->link("Select Employee", array('controller'=> 'Employeesalary', 'action'=>
...
<div class="newbox">
                      <div class="custom_input2">
                          ...
                          <?=$this->Form->input('VCH_PROJECT', ['class'=>'dd', 'label'=> 'Total Salary', 'value'=>$monthly_salary
                    ]);
                    ?>
</</div>
               ...
               <div class="custom_input3">
                 ...
                 <?=$this->Form->input('pdate', ['id'=> 'date-picker', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Month', ]);
        ?>
</</div>
</</div>
</</fieldset>
