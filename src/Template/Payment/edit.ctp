...
<h4 class="inner_title">Edit Payment</h4>
...
?> <div class="proj_dep"><?php
					echo $this->Form->input('pay_date', array(
						'value'=> $pay_date, 'label'=> 'Payment Date', 'id'=> 'birthday', 'class'=>'inp_select', 'Placeholder'=> 'Payment Date', ));
...
<div class="clr"></div>
		 <div class="proj_dep">
			 ...
			 <?php echo $this->Form->input('VCH_DR_ACCOUNTS', ['style'=>'width:400px;float:left', 'label'=> 'Paid To', 'options'=> $paid_to, 'type'=>'select', 'selected'=>'selected'
...
echo $this->Form->input('check_date', array(
						//'type'=> 'select', 'value'=> $ck_date, 'label'=> 'Date', 'class'=>'inp_select', 'id'=> 'chalan_date', 'Placeholder'=> 'Chueque Dates', ));
			?>
</</div>
...
<?php		echo '<div class="radio_all">';
				...
				if( $Payment->VCH_CR_ACCOUNTS==ACC_CASH){
				echo $this->Form->radio(
					'payment_mode', [['value'=> '0', 'checked'=>'checked', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:blue; margin-top:-2px;width:100px;float:left'], ['value'=> '2', 'text'=> 'Check', 'id'=> 'pmode', 'style'=> 'color:blue; margin-top:-2px;width:100px;float:left'], ]
				);
				}
				else{
					echo $this->Form->radio(
					'payment_mode', [['value'=> '0', 'text'=> 'Cash', 'id'=> 'pmode_c', 'style'=> 'color:red; float:left;'], ['value'=> '2', 'checked'=>'checked', 'text'=> 'Check', 'id'=> 'pmode', 'style'=> 'color:blue; float:left;'], ]
				);
				}
...
?>
 <div id="bank_list" class="proj_dep">
	   <?php echo $this->Form->input('VCH_CR_ACCOUNTS', ['style'=>'width:400px;float:left', 'label'=> 'Paid From', 'options'=> $paid_to, 'type'=>'select', 'selected'=>'selected'
			]);
		?>
</</div>
<div class="clr"></div>
...
<?php
            ...
            echo $this->Form->input('VCH_NARRATION', ['type'=> 'text', 'label'=> 'Narration'
					]
				);
?>
	<div class="clr"></div>
