...
<div class="create_btn" ><?php echo $this->Html->link("Create New User Group", array('controller'=> 'Usergroup', 'action'=> 'add')); ?></div>
<div class="create_btn"><?php echo $this->Html->link("Create New User", array('controller'=> 'Users', 'action'=> 'add')); ?></div>
</</div>
