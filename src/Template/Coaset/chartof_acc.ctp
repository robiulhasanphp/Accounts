...
<h5 style="padding-left:10px;" align="right"><?php echo $this->Html->link("Add new Coaset", array('controller'=> 'Coaset', 'action'=> 'add')); ?></h5>
</</div>
<style>
...
<?= $this->Form->input('Name', array(
        'label'=>'Ledger Name', 'options'=> $name, 'type'=>'select', 'style'=>'border:1px solid #ccc;width:120px;'
        )); ?>
</</div>
...
<div class="chekbox">
            ...
            <?php
            echo $this->Form->input('ledger', ['options'=> $LDG_NAME, 'type'=> 'select', 'multiple'=> 'checkbox', 'label'=> false, ]);
            ?>
</</div>
