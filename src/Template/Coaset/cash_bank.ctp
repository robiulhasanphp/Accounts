...
<hr />
    ...
    <td style="width:100px;">
         ...
         <?=$this->Form->input('month', ['id'=> 'birthday', 'type'=>'select', 'class'=>'dd', 'options'=> $month, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> '', 'style'=>'border:1px solid #ccc;width:100px;'

]);
						?>
</</td><td style="width:100px;">
                           <?=$this->Form->input('year', ['id'=> 'employ_date', 'type'=>'select', 'class'=>'dd', 'options'=> $years, 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'Placeholder'=> 'YEAR', 'label'=> '', 'style'=>'border:1px solid #ccc;width:100px;'
