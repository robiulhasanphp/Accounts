...
<div class="proj_dep">
   ...
   <div class="proj_de">
        ...
        <?=$this->Form->input('date_from', ['id'=> 'birthday', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Date from', 'style'=>'border:1px solid #ccc;width:200px;'

]);
						?>

<?=$this->Form->input('date_to', ['id'=> 'employ_date', 'type'=>'text', 'class'=>'dd', 'dateFormat'=> 'YMD', 'minYear'=> date('Y') - 80, 'maxYear'=> date('Y') - 18, 'label'=> 'Date to', 'style'=>'border:1px solid #ccc;width:200px;'
...
?>
    ...
    <span class="heading">Total Debit: </span><span class="value"><?php echo $total_voucher_debit;  ?>
</</span>

    <br/>

<span class="heading">Total Credit: </span><span class="value"><?php echo $total_voucher_credit;  ?>  	</span>
</div>
...
echo '<div style="color:red !important">';
			   echo  abs(number_format($total, 2, '.', '')).'<span style="color: red;" /> Cr </span></div>';
...
echo '<div style="color:green !important">';
			   echo  abs(number_format($total, 2, '.', '')).'<span style="color: green;" /> Dr </span></div>';
...
echo '<div style="color:green !important">';
			   echo  abs(number_format($total, 2, '.', '')).'<span style="color: green;" /> Cr </span></div>';
...
echo '<div style="color:red !important">';
			   echo  abs(number_format($total, 2, '.', '')).'<span style="color: red;" /> Dr </span></div>';
...
$balance=$a->VDT_DEBIT-$a->VDT_CREDIT;
