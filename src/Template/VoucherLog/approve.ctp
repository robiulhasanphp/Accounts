...
<div style="padding-left:500px;">
		  <?= $this->Form->input('name', array(
            'label'=>'User name', 'options'=> $user_name, 'type'=>'select', 'style'=>'border:1px solid #ccc; background:url(../img/bg.png) repeat-x bottom;background-position:center;width:200px;'
        )); ?>
</</div>
...
<?= $this->Form->input('TEXT', array(
            'label'=>'Text', 'type'=>'text', 'style'=>'border:1px solid #ccc; background:url(../img/bg.png) repeat-x bottom;background-position:center;width:200px; height:80px;'
        )); ?>
