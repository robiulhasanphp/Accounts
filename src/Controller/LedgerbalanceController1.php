...
/*end*/						
		...
		$this->set(compact('up_to_lastbalance_credit'));
			...
			$query->select(['t_salary' => $query->func()->sum('VDT_DEBIT')])
			->where(['VDT_LDG_ID' =>$id])
			->andWhere(['VCH_STATUS' =>STS_APPROVED])
...
$total_voucher_debit=$up_to_lastbalance_debit+$voucher_month_between_debit;

$this->set(compact('total_voucher_debit'));

//echo '$up_to_lastbalance_credit='.$up_to_lastbalance_credit."<br>";
//echo '$voucher_month_between_credit='.$voucher_month_between_credit."<br>";

$total_voucher_credit=$up_to_lastbalance_credit+$voucher_month_between_credit;
//echo '$total_voucher_credit='.$total_voucher_credit."<br>";
...
$this->set(compact('total_voucher_credit'));	
		...
		->andWhere(['VDT_LDG_ID not in'=>$id])
		->andWhere(['VDT_DATE >='=>$from_date])
		->andWhere(['VDT_DATE <='=>$to_date])
			->order(['VCH_DATE' =>'Asc']);     //->contain('Basicdata');
